...
actual = ca.Sparsity.from_file(dir+"debug_fatrop_actual.mtx")

A = ca.Sparsity.from_file(dir+"debug_fatrop_A.mtx")
B = ca.Sparsity.from_file(dir+"debug_fatrop_B.mtx")
C = ca.Sparsity.from_file(dir+"debug_fatrop_C.mtx")
D = ca.Sparsity.from_file(dir+"debug_fatrop_D.mtx")
I = ca.Sparsity.from_file(dir+"debug_fatrop_I.mtx")
errors = ca.Sparsity.from_file(dir+"debug_fatrop_errors.mtx").row()
...
plt.hlines(errors, 0, A.shape[1],color='gray', linestyle='-',label="offending rows",alpha=0.5)
